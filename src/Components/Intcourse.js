...
class Intcourse extends React.Component {
  render() {
    return (
      <React.Fragment>
        <a
              ...
              >
                <div className="col-lg-6 col-md-6 col-sm-12">
                  ...
                  <p style={{ "line-height": "1.6" }}>
                    &bull; 500 intermediate vocabulary words
                    <br />
                    &bull; Oxymoron
                    <br />
                    &bull; Anagram redials
                    <br />
                    &bull; Word weaving and Root words
                    <br />
                  </p>
                </div>
                <div className="col-lg-6 col-sm-12 col-md-6">
                  <br />
                  <h2 className="section-heading">Spoken English:</h2>
                  <p style={{ "line-height": "1.6" }}>
                    &bull; We make you practice regressively under the guideline
                    of TRINITY College of London and ESL
                    <br />
                  </p>
                </div>
              </div>
              <div className="row" style={{ "text-align": "center" }}>
                <div className="col-lg-6 col-sm-12 col-md-6">
                  ...
                  <p style={{ "line-height": "1.6" }}>
                    ...
                    &bull; Phrasal verbs
                    <br />
                    &bull; Idioms &amp; Proverbs
                    <br />
                    &bull; Direct &amp; Indirect speech
                    <br />
                    &bull; Sentence clauses
                    <br />
                  </p>
                </div>
                <div className="col-sm-12 col-lg-6 col-md-6">
                  <br />
                  <h2 className="section-heading">Creative Writing:</h2>
                  <p style={{ "line-height": "1.6" }}>
                    &bull; Reading
                    <br />
                    &bull; Comprehension college
                    <br />
                    &bull; Entrance Essay writing(GATE, SAT)
                    <br />
                    &bull; Formal writing <br />
                    &bull; Story and Novel writing <br />
                  </p>
                </div>
                <div className="col-12" style={{ "text-align": "center" }}>
                  <br />
                  <h2 className="section-heading">Bonus Lessons:</h2>
                  <p style={{ "line-height": "1.6" }}>
                    &bull; Interview preparation for college and office jobs.
                    <br />
                  </p>
                </div>
              </div>
