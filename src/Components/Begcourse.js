      ...
      <div className="container">
          <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-12">
              ...
              <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12"><a href="http://enhaancenglish.com"><img src={enlogo} alt style={{"text-align": "center", width: "200px", display:'block', margin: "0 auto", "padding-top":"20px", "padding-bottom":"20px"}}/></a></div>
                <br/>
...
<div className="section">
                <div className="content-wrap"style={{"padding-bottom":"30px"}}>
                   <div className="container" >
                        <h1 className="section-heading" style={{"text-align": "center","font-size":"60px", "text-decoration": "underline", color:"#711379"}}>Beginner Course Curriculum</h1>
                        <div className="row"style={{"text-align": "center", "line-height":"1.6"}}>
                            <div className="col-sm-12 col-lg-6 col-md-6">
                            <br /><h2 className="section-heading">Grammar:</h2>
                        <p style={{"line-height":"1.6"}}>
                            &bull; PARTS OF SPEECH<br />
                            &bull; SENTENCE STRUCTURING<br />
                            &bull; TENSES<br />
                            &bull; MODALS<br />
                            &bull; Auxiliary verbs<br />
                            &bull; Punctuation<br />
                        </p>
                        </div>
                            <div className="col-sm-12 col-lg-6 col-md-6">
                            <br /><h2 className="section-heading">Vocabulary:</h2>
                        <p style={{"line-height":"1.6"}}>
                            &bull; Thousand active words<br />
                            &bull; Synonyms and Antonyms<br />
                        </p>
                        </div>
                        </div>
                        <div className="row"style={{"text-align": "center"}}>
                        <div className="col-sm-12 col-lg-6 col-md-6">
                        <br /><h2 className="section-heading">Conversational English:</h2>
                        <p style={{"line-height":"1.6"}}>
                            &bull; Question formation<br />
                            &bull; Basic greetings<br />
                            &bull; Ten most common situational conversant<br />
                            &bull; Conversation starters<br />
                            &bull; Making request<br />
                            &bull; Seeking permission<br />
                            &bull; Commands<br />
                        </p>
                        </div>
                        <div className="col-sm-12 col-lg-6 col-md-6">
                        <br /><h2 className="section-heading">Creative Skills:</h2>
                        <p style={{"line-height":"1.6"}}>
                            &bull; Story writing<br />
                            &bull; Descriptive writing<br />
                            &bull; Dialogue writing<br />
                            &bull; Formal writing<br />
                        </p>
                        </div>
                        <div className="col-12"style={{"text-align": "center"}}>
                        <br /><h2 className="section-heading">Listening skills:</h2>
                        <p style={{"line-height":"1.6"}}>
                            &bull; 20 minute of active listening in every session<br />
                            &bull; Projects and assignments related to the English movies and web series.<br />
                        </p>
                        </div>
                        </div>
                        </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-md-6 col-lg-4">
            ...
            <a href="http://enhaancenglish.com"><img src={enlogbot} alt="logo bottom" style={{width: "150px"}} className="logo-bottom" /></a>
